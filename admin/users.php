...
<div class="form-group">
<label for="permissions">Permissons</label>
<select name="permissions" id="" class="form-control">
...
$userQuery=$db->query("SELECT * FROM users ORDER BY full_name");
 ...
 <legend>Users</legend>
<a href="users.php?add=1" class="btn btn-sm btn-success pull-right" style="margin-top:-28px;">Add a New User</a>
 <hr>
